# Generated by Django 4.1.3 on 2022-11-02 12:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_ID', models.CharField(default='none', max_length=50)),
                ('BillingPlan', models.CharField(default='none', max_length=50)),
                ('Plan_ID', models.CharField(default='none', max_length=50)),
                ('businessCategory', models.CharField(default='', max_length=500)),
                ('category', models.CharField(choices=[('RETAIL AND ECOMM', 'RETAIL AND ECOMM'), ('CAR RENTAL', 'CAR RENTAL'), ('CAR REPAIR', 'CAR REPAIR'), ('DRIVING SCHOOL', 'DRIVING SCHOOL')], default='None', max_length=30)),
                ...
                ('fb_page_id', models.CharField(default='', max_length=500)),
                ('partiner_web', models.CharField(default='', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('businessCategory', models.CharField(default='', max_length=500)),
                ('category', models.CharField(choices=[('RETAIL AND ECOMM', 'RETAIL AND ECOMM'), ('CAR RENTAL', 'CAR RENTAL'), ('CAR REPAIR', 'CAR REPAIR'), ('DRIVING SCHOOL', 'DRIVING SCHOOL')], default='RETAIL AND ECOMM', max_length=30)),
